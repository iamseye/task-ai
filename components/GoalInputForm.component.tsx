  ...
  return (
    <div className="mt-10 mb-10 items-center justify-center w-full">
      <form onSubmit={onSubmitGenerate}>
        <label
          htmlFor="input-todo"
          className="mb-2 text-xl font-medium text-gray-600 w-full"
        >
        ...
        <div className="flex flex-col">
          <textarea
            ...
            placeholder="e.g. I never make videos before but I want to be a profitable Youtuber... I'm into the topic of travel, software development and food"
            onChange={(event) => setInputGoal(event.target.value.trim())}
          ></textarea>
          <button
            type="submit"
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 mt-5"
          >
